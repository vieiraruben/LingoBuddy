    ...
    <section class="clean-block clean-form dark">
        <div class="container">
            ...
            <form action="account-view.php" method="post">
                <div class="mb-3"><label class="form-label" for="first_name">First Name</label>
                    <input value="<?php echo user_first_name($user) ?>" required class="form-control" type="text" id="name" name="first_name">
                </div>
                <div class="mb-3"><label class="form-label" for="last_name">Last Name</label>
                ...
                <div class="mb-3"><label class="form-label" for="phone_number">Phone Number</label>
                    <input value="<?php echo user_phone($user) ?>" required class="form-control" type="tel" id="phone_number" name="phone_number">
                </div>
                <div class="mb-3"><label class="form-label" for="country">Country</label>
                ...
                <div class="mb-3"><button class="btn btn-primary" name="submit" type="submit">Confirm</button></div>
            </form>
        </div>
    </section>
</main>
